export const CopilotIcon = () => (
  <svg preserveAspectRatio="xMidYMid" viewBox="0 0 256 208" className="w-6 h-6">
    <path
      fill="#fff"
...
export const AntigravityIcon = () => (
  <svg viewBox="0 0 16 15" fill="none" className="w-6 h-6">
    <mask
...
export const CodexIcon = () => (
  <svg preserveAspectRatio="xMidYMid" viewBox="0 0 256 260" className="w-6 h-6">
    <path
      fill="#fff"
...
export const ClaudeCodeIcon = () => (
  <svg preserveAspectRatio="xMidYMid" viewBox="0 0 256 257" className="w-6 h-6">
    <path
      fill="#D97757"
...
export const GeminiIcon = () => (
  <svg viewBox="0 0 296 298" fill="none" className="w-6 h-6">
...
export const KimiIcon = () => (
  <svg viewBox="0 0 512 512" fillRule="evenodd" clipRule="evenodd" strokeLinejoin="round" strokeMiterlimit="2" className="w-6 h-6">
...
export const ZaiIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" fillRule="evenodd" viewBox="0 0 24 24" className="w-6 h-6">
    <title>Z.ai</title>
...
export const AmpCodeIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6">
    <title>Amp Code</title>
    <image href="https://i.ibb.co/W4gJVH0y/favicon-V2.png" width="24" height="24" />
  </svg>
)

export const QwenIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 512 511" className="w-6 h-6">
    <path
      fill="#615CED"
      fillRule="evenodd"
      clipRule="evenodd"
      d="M336.6,204.1c1,0,1.4,0.3,0.7,1.4l-19.4,33.9L257.4,346c0,0.3-0.7,0.7-1,0.7s-1,0-1-0.7L175,205.8  c-0.3-0.7,0-1,0.7-1.4h4.8l156-0.7l0,0L336.6,204.1z M190.6,18c-0.7,0-1,0-1,0.7l-66.4,116.6c-0.7,1-1.7,1.7-3.1,1.7H53.6  c-1.4,0-1.7,0.7-1,1.7l134.9,235.9c0.7,1,0,1.4-0.7,1.4h-65c-2.1,0-3.8,1-4.5,3.1l-30.8,53.6c-1,1.7-0.3,2.8,1.7,2.8H221  c1,0,1.7,0.7,2.4,1.7l32.5,57.1c1,1.7,2.1,2.1,3.1,0l116.2-203.4l18.3-32.2c0-0.3,0.7-0.7,1-0.7c0.3,0,1,0,1,0.7l33.2,58.8  c0.7,1,1.4,1.4,2.4,1.4h64c0.3-0.3,0.7-0.7,0.7-1c0,0,0-0.7,0-1l-67.5-118c-0.7-1-0.7-1.7,0-2.8l6.9-11.8l25.9-46  c0.7-1,0-1.4-0.7-1.4H191.6c-1.4,0-1.7-0.7-1-1.7l33.2-58.1c0.7-1,0.7-1.7,0-2.8L192,18.7C192,18.3,191.3,18,190.6,18L190.6,18  L190.6,18z M270.2,8.6c9,15.9,18.3,32.2,27.3,48.1c0.7,1.4,2.1,2.1,3.8,2.1h129c4.2,0,7.6,2.4,10.4,7.6l33.9,59.8  c4.5,8,5.5,11.1,0.7,19.4c-5.9,10-11.8,20.1-17.6,30.1L449,191c-2.4,4.5-5.2,6.6-1,11.8l61.6,107.6c4.2,6.9,2.4,11.4-1,18  c-10,18.3-20.4,36.3-31.1,54.3c-3.8,6.2-8.3,8.6-15.9,8.6c-18-0.3-36,0-54,0.3c-0.7,0-1.4,0.3-1.7,1c-20.8,36.7-41.9,73.3-63,110  c-3.8,6.9-9,8.3-17,8.3c-23.2,0-46.4,0-70.2,0c-4.8,0-8.3-2.1-10.7-6.2l-31.1-54c-0.3-0.7-1-1-2.1-1h-119c-6.6,0.7-12.8,0-18.7-2.1  l-37.4-64.3c-2.4-4.2-2.4-8.3,0-12.5l28-49.1c1-1.4,1-3.1,0-4.5c-14.5-25.3-29.1-50.5-43.6-76.1L2.8,208.6  c-3.8-7.3-4.2-11.4,2.1-22.5c10.7-19,21.4-37.7,32.2-56.7c3.1-5.5,6.9-7.6,13.5-7.6c20.1,0,40.1,0,60.2,0c1,0,2.1-0.3,2.4-1.4  l65-113.8c2.1-3.8,5.5-5.5,9.7-5.9c12.1,0,24.6,0,36.7,0L248,0c8,0,17,0.7,20.8,8L270.2,8.6z"
    />
  </svg>
)
...
export const MinimaxIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6">
    <title>Minimax</title>
    <image href="https://i.ibb.co/qMtG4KmP/Mini-Max.png" width="24" height="24" />
  </svg>
)
