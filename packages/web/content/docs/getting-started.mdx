...
```bash
# bun
bun add -g @anthropic-cli/arctic

# npm
npm install -g @arctic-cli/arctic

# pnpm
pnpm add -g @arctic-cli/arctic

# yarn
yarn global add @arctic-cli/arctic
```
...
- **Linux only**: `xclip` for clipboard support (`sudo apt install xclip`)
...
<Cards>
  <Card title="TUI" href="/docs/tui" description="Keyboard-first workflow" />
  <Card title="CLI Commands" href="/docs/commands" description="Run prompts and manage sessions" />
  <Card title="Providers" href="/docs/providers" description="Auth and provider setup" />
  <Card title="Config" href="/docs/config" description="Customize Arctic" />
</Cards>
