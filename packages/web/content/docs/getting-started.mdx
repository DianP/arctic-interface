...
- Docs: [https://arcticli.com/docs](https://arcticli.com/docs)
- Issues: [https://github.com/arctic-cli/cli/issues](https://github.com/arctic-cli/cli/issues)
- Discord: [https://discord.gg/arctic](https://discord.gg/arctic)
