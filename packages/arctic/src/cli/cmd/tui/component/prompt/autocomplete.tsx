...
export function Autocomplete(props: {
  ...
  const commands = createMemo((): AutocompleteOption[] => {
    ...
    results.push(
      {
        display: "/benchmark",
        description: "benchmark mode commands",
        onSelect: () => {
          const newText = "/benchmark "
          const cursor = props.input().logicalCursor
          props.input().deleteRange(0, 0, cursor.row, cursor.col)
          props.input().insertText(newText)
          props.input().cursorOffset = Bun.stringWidth(newText)
      ...
      {
        display: "/benchmark start",
        description: "start benchmark mode",
        onSelect: () => {
          const newText = "/benchmark start "
          const cursor = props.input().logicalCursor
          props.input().deleteRange(0, 0, cursor.row, cursor.col)
          props.input().insertText(newText)
          props.input().cursorOffset = Bun.stringWidth(newText)
      ...
      {
        display: "/benchmark stop",
        description: "stop benchmark mode",
        onSelect: () => {
          const newText = "/benchmark stop"
          const cursor = props.input().logicalCursor
          props.input().deleteRange(0, 0, cursor.row, cursor.col)
          props.input().insertText(newText)
          props.input().cursorOffset = Bun.stringWidth(newText)
      ...
      {
        display: "/benchmark next",
        description: "next benchmark slot",
        onSelect: () => {
          const newText = "/benchmark next"
          const cursor = props.input().logicalCursor
          props.input().deleteRange(0, 0, cursor.row, cursor.col)
          props.input().insertText(newText)
          props.input().cursorOffset = Bun.stringWidth(newText)
      ...
      {
        display: "/benchmark prev",
        description: "previous benchmark slot",
        onSelect: () => {
          const newText = "/benchmark prev"
          const cursor = props.input().logicalCursor
          props.input().deleteRange(0, 0, cursor.row, cursor.col)
          props.input().insertText(newText)
          props.input().cursorOffset = Bun.stringWidth(newText)
      ...
      {
        display: "/benchmark apply",
        description: "apply current slot changes",
        onSelect: () => {
          const newText = "/benchmark apply"
          const cursor = props.input().logicalCursor
          props.input().deleteRange(0, 0, cursor.row, cursor.col)
          props.input().insertText(newText)
          props.input().cursorOffset = Bun.stringWidth(newText)
      ...
      {
        display: "/benchmark undo",
        description: "undo applied changes",
        onSelect: () => {
          const newText = "/benchmark undo"
          const cursor = props.input().logicalCursor
          props.input().deleteRange(0, 0, cursor.row, cursor.col)
          props.input().insertText(newText)
          props.input().cursorOffset = Bun.stringWidth(newText)
  ...
  function hide() {
    ...
    if (store.visible === "/" && !text.includes(" ") && !text.endsWith(" ") && text.startsWith("/")) {
      const cursor = props.input().logicalCursor
      props.input().deleteRange(0, 0, cursor.row, cursor.col)
