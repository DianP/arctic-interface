          ...
          return [
            {
              ...
              category: "Favorites",
              disabled: provider.id === "arctic" && model.id.includes("-nano"),
              footer: model.cost?.input === 0 && provider.id === "arctic" ? "Free" : undefined,
              onSelect: () => {
                dialog.clear()
                local.model.set(
                  {
          ...
          pipe(
            ...
            map(([model, info]) => {
              ...
              return {
                ...
                disabled: provider.id === "arctic" && model.includes("-nano"),
